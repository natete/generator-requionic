...
module.exports = yeoman.generators.Base.extend({
  ...
  writing: {
    ...
    createSyles: function() {
      ...
      var destinationPath = 'www/js/modules/' + _.toLower(this.ModuleName) + '/' + _.toLower(this.viewName) + '.scss';
      this.fs.copyTpl(
      ...
      this.fs.copy(
        ...
        this.destinationPath('scss/' + appName + '.scss'), {
          process: function(content) {
            ...
            var newContent = content.toString().replace(regEx, '@import "' + '../www/js/modules/'  + _.toLower(this.ModuleName) + '/' + _.toLower(this.viewName) + '";\n' + hook);
            return newContent;
          }
        }
      )
